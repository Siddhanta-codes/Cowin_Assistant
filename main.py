...
#Response Fetching
flag=True
print(colored("Arya 2.0:\nI am Arya 2.0, I have all the answers If you want to exit, type Ciao",'blue',attrs=['bold']))
while(flag==True):
    print(colored("\nYOU:",'red',attrs=['bold']))
    u_input = input()
    ...
    if(u_input!='ciao'):
        ...
        flag=False
        print(colored("\nNArya 2.0: Bye! take care..",'blue', attrs=['bold']))
